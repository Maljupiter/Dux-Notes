...
export type BlankPageTemplate = 'ruled' | 'plain' | 'grid';
...
declare global {
  interface Window {
    ...
    localNotes: {
      ...
      savePdfExport: (defaultFileName: string, pdfBytes: Uint8Array | ArrayBuffer, editableSidecar?: unknown) => Promise<string | null>;
      savePdfExportToFolder?: (folderPath: string, defaultFileName: string, pdfBytes: Uint8Array | ArrayBuffer, editableSidecar?: unknown) => Promise<string | null>;
